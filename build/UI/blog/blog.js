import { retrieveFromStore, saveLocally, } from "../../modules/helperFunction.js";
                ...
                <div class="link_reaction">
                    ...
                    <section class="reaction">
                        <div class="buttons">
                            ...
                            <p>${(_a = blog === null || blog === void 0 ? void 0 : blog.comments) === null || _a === void 0 ? void 0 : _a.length}</p>
                        </div>
                        <div class="buttons">
                            <button id="your_like">
      ...
      `;
        ...
        if (commentForm && commentatorContainer) {
            commentForm.addEventListener("submit", (event) => {
                ...
                const comments = { name, comment: commentText };
                const blogArray = retrieveFromStore("blogs");
                const blogIndex = blogArray.findIndex((blog) => blog.id === blogToRead.id);
                const blogToComment = blogArray[blogIndex];
                const commentArr = blogToComment.comments;
                if (commentArr) {
